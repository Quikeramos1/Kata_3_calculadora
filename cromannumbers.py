...
#los siguientes metodos enmascarados de propiedad, nos permiten modificar el valor del número y símbolo.
    ...
    '''
    metodo mágicos para aritmética
    '''
    ...
    '''
    metodos mágicos para representacion
    '''
